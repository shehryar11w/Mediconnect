...
const FeedbackScreen = () => {
  ...
  const fetchAppointments = async () => {
    try {
      setIsLoading(true);
      setError(null);
      const response = await feedbackService.getPatientAppointments(currentUser.id);
  ...
  const renderStar = (index: number) => (
    ...
    >
      <Ionicons
        ...
        size={32}
        color={index < rating ? colors.patientPrimary : colors.textLight}
      />
    </TouchableOpacity>
  );
    ...
    <View style={[globalStyles.container, styles.container]}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.section}>
          <ThemedText style={styles.sectionTitle}>Previous Appointments</ThemedText>
          {isLoading ? (
            ...
            <View style={[styles.errorContainer, { backgroundColor: colors.background }]}>
              ...
              <TouchableOpacity
                style={[styles.retryButton, { backgroundColor: colors.patientPrimary }]}
            ...
            appointments.map((appointment) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedAppointment?.id === appointment.id && styles.selectedCard
                ]}
                onPress={() => {
              ...
              >
                <View style={styles.appointmentInfo}>
                  ...
                  <ThemedText style={[styles.specialty, { color: colors.textLight }]}>
                    {appointment.specialty}
                  </ThemedText>
                  <ThemedText style={[styles.dateTime, { color: colors.textLight }]}>
                  ...
                  <View style={styles.ratingContainer}>
                    {[0, 1, 2, 3, 4].map((index) => (
                      <Ionicons
                        ...
                        size={16}
                        color={index < appointment.rating! ? colors.patientPrimary : colors.textLight}
                      />
                    ))}
                  </View>
                )}
        ...
        {selectedAppointment && (
          <View style={[styles.card, { backgroundColor: colors.background }]}>
            <View style={styles.section}>
              ...
              <ThemedText style={[styles.ratingText, { color: colors.textLight }]}>
            ...
            <TouchableOpacity
              style={[styles.submitButton, { 
                backgroundColor: rating > 0 ? colors.patientPrimary : colors.textLight,
