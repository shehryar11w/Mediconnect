        ...
        const fetchReceipt = async () => {
            try {
                ...
                if (response.success) {
                    setReceipt({
                        appointmentId:
                            response.data[0].appointmentId.toString(),
                    ...
                    <View style={styles.costBreakdown}>
                        <View style={styles.costRow}>
                            ...
                            <ThemedText style={styles.costValue}>
                                PKR {receipt.baseRate.toLocaleString()}
                            </ThemedText>
                        </View>
                        {receipt.timePremium > 0 && (
                            <View style={styles.costRow}>
                                ...
                                <ThemedText style={styles.costValue}>
                                    +PKR {receipt.timePremium.toLocaleString()}
                                </ThemedText>
                            </View>
                        )}
                        <View style={[styles.costRow, styles.totalRow]}>
                            <ThemedText
                                style={[styles.costLabel, styles.totalLabel]}
                            >
                                Total Amount
                            </ThemedText>
                            <ThemedText
                                style={[styles.costValue, styles.totalValue]}
                            >
