  ...
  const fetchChatDetails = async () => {
    try {
      ...
      const pat = {
        ...
        patientSpecialization: response.data.chatDetails.patientSpecialization,
    ...
    >
      ...
      <View
        style={[
          ...
          {
            backgroundColor: isDoctorMessage(item.MessageSenderType) ? colors.background : '#FF4444',
          },
        ]}
      >
        <ThemedText
          style={[
            styles.messageText,
            { color: isDoctorMessage(item.MessageSenderType) ? colors.text : colors.background },
          ]}
        >
          {item.MessageContent}
        </ThemedText>
        <View style={styles.messageFooter}>
          <ThemedText
            style={[
              styles.messageTime,
              { color: isDoctorMessage(item.MessageSenderType) ? colors.textLight : colors.background + 'CC' },
            ]}
          >
      ...
      <View style={[styles.inputContainer, { backgroundColor: colors.background }]}>
        ...
        <TouchableOpacity
          style={[
            styles.sendButton,
            {
              backgroundColor: message.trim().length > 0 ? colors.doctorPrimary : colors.textLight,
            },
          ]}
          onPress={sendMessage}
